...
import { LayoutDashboard, ListChecks, Users, LogOut, Images, UserCog, UserCheck, BookOpen, TrendingUp, CalendarDays } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="w-60 bg-white border-r border-gray-200 flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-3 space-y-1">
          ...
          <Link href="/admin/schedule" className="flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
            <CalendarDays className="w-4 h-4" />
            ตารางสอน
          </Link>
          <Link href="/admin/revenue" className="flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
