...
export default function SuperAdminBannersPage() {
  ...
  const load = async () => {
    setLoading(true);
    const [bannersRes, instRes] = await Promise.all([
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">แบนเนอร์ทั้งหมดของระบบ — กำหนดการแสดงผลได้</p>
        </div>
        <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 resize-none"
                />
              </div>
              <div className="md:col-span-2">
