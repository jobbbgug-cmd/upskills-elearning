              ...
              <div key={u._id} className="bg-white rounded-xl md:rounded-2xl border border-gray-200 p-4 md:p-5 flex flex-col md:flex-row md:items-center md:gap-4 gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {u.institutionId && (
                      <span className="inline-flex items-center gap-0.5 text-xs font-semibold px-2 py-0.5 rounded-full" style={{ color: 'var(--color-primary)', backgroundColor: 'rgba(var(--color-primary-rgb), 0.1)' }}>
                  ...
                  {u.contactChannel && (
                    <div className="flex items-center gap-1.5 mt-2 rounded-lg px-2 md:px-2.5 py-1 text-xs font-medium flex-wrap" style={{ backgroundColor: 'rgba(var(--color-primary-rgb), 0.1)', borderColor: 'rgba(var(--color-primary-rgb), 0.2)', color: 'var(--color-primary)', border: '1px solid' }}>
