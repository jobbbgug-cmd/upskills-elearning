      ...
      <div className="flex flex-wrap gap-2 mb-5 items-center">
        ...
        <div className="relative ml-auto">
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)}
            ...
            className="pl-10 pr-4 py-2 border border-gray-200 rounded-xl text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 w-56" />
        </div>
      </div>
                ...
                <div className="flex-1 space-y-2 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {booking.userId?.gradeLevel && (
                      <span className="text-xs bg-violet-50 text-violet-600 px-2 py-0.5 rounded-full">{booking.userId.gradeLevel}</span>
                    )}
                  </div>
                ...
                <div className="flex flex-col items-center gap-1 shrink-0">
                  ...
                  {booking.slipImage ? (
                    <button onClick={() => setPreviewSlip(booking.slipImage)}
                      className="group relative w-24 h-28 rounded-xl overflow-hidden border border-gray-200 hover:border-violet-300 transition-colors">
